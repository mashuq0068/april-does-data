...
const HeroSection = ({
  ...
  return <section id="home" className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50  ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-xl font-bold gradient-text uppercase text-gray-900 mb-3 leading-tight">
              ...
              <span className="text-blue-60 gradient-text">Confident Decisions.</span>
            </h1>
